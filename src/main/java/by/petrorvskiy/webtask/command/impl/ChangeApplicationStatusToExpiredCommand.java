...
public class ChangeApplicationStatusToExpiredCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            ...
            isChanged = searchApplicationService.updateSearchApplicationStatus(SearchApplication.ApplicationStatus.EXPIRED,id);
            ...
            logger.error( "ServiceException in method execute ChangeApplicationStatusToExpiredCommand" + e);
